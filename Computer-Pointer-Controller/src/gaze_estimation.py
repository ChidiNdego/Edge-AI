...
class GazeEstimation:
    ...
    def predict(self, left_eye_image, right_eye_image, head_pose_output):
        ...
        '''
        leye_image, reye_image = self.preprocess_input(left_eye_image.copy(), right_eye_image.copy())
        result = self.exec_net.infer({'left_eye_image': leye_image, 'right_eye_image': reye_image, 'head_pose_angles': head_pose_output})
        mouse_coord, gaze_vector = self.preprocess_output(result, head_pose_output)
